...
const DelayNode: FC<Props> = props => {
  ...
  useEffect(() => {
    ...
    setDelay(node);
    if (destination instanceof AudioNode) return () => node.disconnect(destination);
